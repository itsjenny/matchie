	...
	return (
		<div>
			...
			<div class='main' style={{ position: 'relative', zIndex: 1 }}>
				<h1 style={{ fontSize: '4vw', padding: '1vw', }}>Second person your turn to swipe!</h1>
					...
					{props.master.map(anime =>
						<TinderCard onSwipe={(dir) => swiped(dir, anime)} preventSwipe={['up', 'down']}>
							<ReactCardFlip isFlipped={isFlipped} flipDirection='horizontal' >
								<div class='bigCard'>
									...
									<div class='info'>
										...
										<div style={{ position: 'absolute', bottom: '0vw', width: '50%', padding: '0' }}>
											...
											<div style={{ color: '#2b1b2d', width: '100%', height: '25%', fontSize: '0.8vw', padding: '0' }}
												class='nextButton'
												onClick={handleClick}>
								...
								<div class='bigCard'>
									<p style={{ color: '#2b1b2d', height: '10%', fontSize: '150%', padding: '2%', fontWeight: 'bolder' }}>
									...
									<div style={{ color: '#2b1b2d', position: 'absolute', top: '22vw', width: '90%', height: '5%', fontSize: '0.8vw', padding: '0' }}
										class='nextButton' onClick={handleClick}>
										Click to flip back!
											</div>
								</div>
							</ReactCardFlip>
				...
				<div style={{ color: '#FFF', position: 'absolute', left: '40%', top: '12vw', width: '20%', height: '3%', fontSize: '1vw', padding: '0', zIndex: '-1' }}
					class='nextButton' onClick={() => props.prevStep()}>
					Return to the first person's swiping
				</div>
				<div style={{ color: '#FFF', position: 'absolute', left: '40%', top: '15vw', width: '20%', height: '3%', fontSize: '1vw', padding: '0', zIndex: '-1', }}
					class='nextButton' onClick={() => { props.returnSwipe(2, yes, 'yes'); props.nextStep() }}>
					Find your matches!
               </div>
			</div>
		</div>
